"""
ori-ndx-builder — BoCoFlow node wrapper.
...
class OriNdxBuilder(Node):
    ...
    def execute(self, predecessor_data, flow_vars):
        ...
        try:
            ...
            if not structure:
                raise NodeException("ori_ndx_builder", "Structure file required.")
            ...
            if not ndx_result.success:
                raise NodeException("ori_ndx_builder", f"Index generation failed: {ndx_result.log}")
            ...
            raise NodeException("ori_ndx_builder", str(e))
